...
def feature_extraction(output_dir: str, whisper_transcription_path:str, csv_segment_path:str) -> None:
    output_feature_file = Path(output_dir) / f"adresso_features.csv"
